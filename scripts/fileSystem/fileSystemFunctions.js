...
//verifica se os caminhos existem, se não, cria o caminho que não existe
    ...
    fileDirEstabelecimentoCreator :  async function (estabeleciimento){
        ...
        //caso o Dir já exista o código não para / o codigo não para se for pego um erro
        try {
            //cria o dir
            // joga um erro se o dir já existir
            await fs.promises.mkdir('fileSystem\\Imagens\\'+estabeleciimento);
